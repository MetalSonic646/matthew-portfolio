...
- JavaScript interaction using DOM event handling
- GitHub profile integration

## Project Included
### Redlands Place Finder
Frontend web application that loads JSON location data and dynamically renders locations using JavaScript DOM manipulation.

## Author
Matthew Bussell

GitHub:
https://github.com/MetalSonic646
